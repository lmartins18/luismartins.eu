    ...
    <div className="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:gap-y-12">
      ...
      <div className="lg:order-first lg:row-span-2">
        <h1 className="text-4xl font-bold tracking-tight text-zinc-800 dark:text-zinc-100 sm:text-5xl">
          I’m Luis. I live in New York City, where I design the future.
        </h1>
      ...
      <div className="mt-2 border-t border-zinc-100 pt-8 dark:border-zinc-700/40 flex justify-end ml-12">
        ...
        >
          <svg
            viewBox="0 0 24 24"
            aria-hidden="true"
            className="h-6 w-6 flex-none fill-zinc-500 transition group-hover:fill-cyan-500 dark:group-hover:fill-red-500"
          >
            <path
              fill-rule="evenodd"
